...
A contribution has been added to the package to allow for the OpenSafely data to be examined. To get the [OpenSafely data](https://codelists.opensafely.org/docs/) you can specify the code list required and this will pull it into a list. To do this follow the below example:
