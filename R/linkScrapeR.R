...
#'
#' Once the links have been scraped they will be outputted into a tibble for exprloration.
#'
...
linkScrapeR <- function(url, SSL_needed = FALSE){
  tryCatch(
      ...
      error = function(e){
        message(cat
                ("There has been an issue with the return.\n","Please check url passed to the function, or set the SSL_needed parameter to FALSE, as the sites SSL certificate may have expired."))
      }
